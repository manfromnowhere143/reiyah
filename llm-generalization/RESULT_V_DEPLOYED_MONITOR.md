...
2026-09-06 at the scene level and not supported (Result Z, `inconclusive`); it is a conjecture, not
a result. This is calibrated and evaluated on one benchmark and one jury; it is not a
