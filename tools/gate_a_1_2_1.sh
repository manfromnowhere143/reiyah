...
if [ "$REIYAH_GATE_ROOT" != "/Users/danielwahnich/workspace/reiyah" ]; then
    echo "gate_a_1_2_1 launcher error: working directory must be /Users/danielwahnich/workspace/reiyah" >&2
    exit 2
fi
...
exec /usr/bin/sandbox-exec -p "$REIYAH_GATE_SEATBELT" \
    ...
    /Users/danielwahnich/workspace/reiyah/tools/gate_a_1_2_1.py "$@"
