...
| G | derived, bounded | Required validation evidence scales as the square root of the lift, so the real cost is about 26% more evidence, not 59%. Result K supplies the interval: +26.0%, 95% CI [25.0, 26.9] at the instance unit. |
...
| K | measured | The evidence-cost number, at the instance unit, with an interval. Marginal lift at score 0.3 is 1.587, 95% CI [1.564, 1.612] over 8,976 independent tracked objects. Evidence requirement is +26.0%, 95% CI [25.0, 26.9]. At RSS's own worked target that is 97,596 examples per subsystem, 95% CI [96,860, 98,332], against 77,460 under independence. Pays the interval debt Audit 1 raised against Results D and G. The OFFICIAL denominator gives a higher lift, 1.630, consistent with Result B. See [`result_k.txt`](../evidence/measurement/result_k.txt). |
